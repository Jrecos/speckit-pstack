...
- reads of any `SKILL.md` file the session can reach (project skills under `.specify/pstack/skills/`, packaged skills under `.specify/extensions/pstack/resources/skills/`)
