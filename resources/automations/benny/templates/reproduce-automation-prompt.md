...
> Source material for the copied setup workflow. Turn this intent into a job request for the supplied scheduler only after proving the pack is committed in the repository and revision the job will run.

Read and follow `.specify/pstack/automations/benny/skills/reproduce-and-fix-issues/SKILL.md` for this run.
