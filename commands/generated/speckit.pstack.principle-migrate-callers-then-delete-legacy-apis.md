...
# Principle Migrate Callers Then Delete Legacy Apis (pstack)
...
`.specify/extensions/pstack/resources/skills/principle-migrate-callers-then-delete-legacy-apis/SKILL.md`
