...
# Principle Separate Before Serializing Shared State (pstack)
...
`.specify/extensions/pstack/resources/skills/principle-separate-before-serializing-shared-state/SKILL.md`
